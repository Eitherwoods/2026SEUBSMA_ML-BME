...
\subsection*{静息心率数据}
来源于MSD Veterinary Manual (Merck Sharp \& Dohme Corp.)，该手册是全球兽医领域的权威参考文献。数据链接为：\url{https://www.msdvetmanual.com/multimedia/table/resting-heart-rates}
...
\section{分工说明}
栾家诺主要负责模型验证中的数据处理和可视化分析，同时负责论文撰写和数学建模推导的审核。
\par
王梓睿主要负责关于基础代谢率、心率和质量关系的一系列理论建模与推导,同时负责论文的审核。
\section{源代码}
