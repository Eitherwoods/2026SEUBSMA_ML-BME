...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{figure/HW1figure/dt0.001.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{figure/HW1figure/dt0.1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figure/HW1figure/simulink.png}
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figure/HW1figure/ode4S0.001.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figure/HW1figure/ode4T0.001.png}
    \end{minipage}
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figure/HW1figure/ode4S0.1.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figure/HW1figure/ode4T0.1.png}
    \end{minipage}
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figure/HW1figure/ode1S0.001.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figure/HW1figure/ode1T0.001.png}
    \end{minipage}
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figure/HW1figure/ode1S0.1.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figure/HW1figure/ode1T0.1.png}
    \end{minipage}
...
\section{代码附录}
\inputMATLAB{codes/HW1codes/main.m}
\inputMATLAB{codes/HW1codes/EulerMethod.m}
\inputMATLAB{codes/HW1codes/ode45Solver.m}
\inputMATLAB{codes/HW1codes/rk4Method.m}